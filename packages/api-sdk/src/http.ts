...
function resolveBaseUrl(baseUrl: string): string {
  ...
  throw new Error('createFetchClient: absolute baseUrl required when window.location is unavailable')
}
      ...
      try {
        ...
        if (data && typeof data === 'object') {
          problem = {
            ...
            errors: typeof data.errors === 'object' ? (data.errors as Record<string, unknown>) : undefined,
          }
        }
      } catch {}
