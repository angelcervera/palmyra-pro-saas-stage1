	...
	return (
		<Routes>
			<Route element={<AdminLayout />}>
				...
				<Route
					path="/schema-categories/new"
					element={<SchemaCategoriesCreatePage />}
				/>
				<Route
					path="/schema-categories/:categoryId/edit"
					element={<SchemaCategoriesEditPage />}
				/>
				<Route path="/schema-repository" element={<SchemaRepositoryPage />} />
				<Route
					path="/schema-repository/new"
					element={<SchemaRepositoryCreatePage />}
				/>
				<Route
