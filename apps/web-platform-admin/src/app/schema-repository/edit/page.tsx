...
import { SchemaVersionForm, type SchemaVersionFormValues, type SchemaVersionSubmitPayload } from '../schema-version-form'
import { useCreateSchemaVersion, useSchemaVersion } from '../use-schema-repository'
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Review immutable attributes and update the JSON schema definition as needed.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <SchemaVersionForm
          ...
          />
          {isLoading && !data && <p className="text-muted-foreground mt-4 text-sm">Loading schema version…</p>}
        </CardContent>
      </Card>
    </div>
  )
