...
import { SchemaVersionForm, type SchemaVersionSubmitPayload } from '../schema-version-form'
    ...
    <div className="flex flex-1 flex-col gap-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Register a new JSON schema definition and classify it under the right category.
          </p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Provide the identifiers and JSON schema contents that describe this version.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <SchemaVersionForm
